...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Moonshining1/management-music")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/c9dd6e4b0f44985162024.jpg"
)
PING_VID_URL = getenv(
